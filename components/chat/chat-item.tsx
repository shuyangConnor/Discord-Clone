                        ...
                        <FormControl>
                          <div className="relative w-full">
                            <Input
                              ...
                              {...field}
                              className="p-2 bg-zinc-200/90 dark:bg-zinc-700/75 border-none border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200"></Input>
                          </div>
                        </FormControl>
                      </FormItem>
                    )
        ...
        <div className="hidden group-hover:flex items-center gap-x-2 absolute p-1 top-0 right-5 bg-white dark:bg-zinc-800 border rounded-sm">
            ...
            <div ref={editBtnRef}>
              <ActionTooltip label="Edit">
                <Edit
                  ...
                  className="cursor-pointer ml-auto w-4 h-4 text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300 transition"></Edit>
              </ActionTooltip>
            </div>
          )}
          <ActionTooltip label="Delete">
            <Trash
              ...
              className="cursor-pointer ml-auto w-4 h-4 text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300 transition"></Trash>
          </ActionTooltip>
        </div>
      )}
    </div>
